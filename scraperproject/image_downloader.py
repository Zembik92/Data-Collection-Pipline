...
my_path = 'C:/Users/kambo/Desktop/Data-Collection-Pipeline/scraperproject/raw_data/hotels/images/'
...
class Downloader:
    ...
    def load_file(self):
        ...
        with open(r"C:\Users\kambo\Desktop\Data-Collection-Pipeline\scraperproject\raw_data\hotels\data.json") as file:
            data = json.load(file)  
    ...
    def folder(self):
        ...
        newpath = r'C:\Users\kambo\Desktop\Data-Collection-Pipeline\scraperproject\raw_data\hotels\images'

...
class Scraper:
    ...
    def __init__(self) -> None:
        ...
        self.dict_properties = {'ID': [],'Timestamp': [],'Hotel Name': [],'Price': [],'Location': [],'Rating/10': [],'Image URL': []}
    ...
    def create_folders(self) -> None:
        ...
        newpath = r'C:\Users\kambo\Desktop\Data-Collection-Pipeline\scraperproject\raw_data\hotels'
    ...
    def create_file(self) -> None:
        ...
        with open(r'C:\Users\kambo\Desktop\Data-Collection-Pipeline\scraperproject\raw_data\hotels\data.json', 'w') as file:
